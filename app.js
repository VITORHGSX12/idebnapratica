...
`;
    ...
    // =========================================================================
    // MÓDULO DE AVALIAÇÕES DIAGNÓSTICAS & SIMULADOS (NOVO MODELO OFICIAL SAEB)
    // O gerenciamento completo de Eventos, Gabaritos, Espelho de Lançamento,
    // Analytics, Heatmap e Impressão é tratado por js/modules/avaliacoes/
    // =========================================================================
...
// (Gestão de Turmas, Professores e Modais de Diário/Proficiência: gerenciados em js/modules/turmas/turmas_diario.js)
    ...
    // (Módulos de Matrizes BNCC, Cronograma Pedagógico, Diagnóstico e Biblioteca A4: gerenciados em seus respectivos módulos em js/modules/)
