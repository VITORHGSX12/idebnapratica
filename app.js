...
// (Metas e Comparativo IDEB: gerenciados em js/modules/metas/metas_ideb.js)
...
`;
    ...
    // (Módulo Turmas & Diário de Classe: gerenciado em js/modules/turmas/turmas_diario.js)
...
if (document.readyState === 'loading') {
    ...
    // (Regras de Avaliações, 19 UREs e Rankings Regionais do IDEB: gerenciados em js/modules/metas/metas_ideb.js)
...
// (Gestão de Turmas, Professores e Modais de Diário/Proficiência: gerenciados em js/modules/turmas/turmas_diario.js)
    ...
    // (Metas e Planos PDE de Gonçalves Dias: gerenciados em js/modules/metas/metas_ideb.js)
